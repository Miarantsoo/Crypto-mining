                  ...
                  <div className="mb-5 flex flex-row justify-between items-center">
                      <div className="">
                          ...
                          <p className="font-body text-slate-500">
                              Cette page liste l'entièreté des demandes effectués par
              ...
              {demandes && demandes.length > 0 && (
                <div className="border rounded-lg overflow-hidden shadow-md">
                      <table className="w-full text-left table-fixed min-w-max rounded-lg font-body">
                          ...
                          <tr className="">
                              <th className="p-4 text-lg text-main font-extrabold">Utilisateur</th>
                              <th className="p-4 text-lg text-main font-extrabold">Date</th>
                              <th className="p-4 text-lg text-main font-extrabold">Depot</th>
                              <th className="p-4 text-lg text-main font-extrabold">Retrait</th>
                              <th className="p-4 text-lg text-main font-extrabold">Actions</th>
                          </tr>
                          </thead>
                          <tbody>
                          {demandes.map((item) => (
                              ...
                              >
                                  ...
                                  <td className="p-4 flex flex-row gap-5">
                                      <button className="px-5 py-3 rounded-lg bg-secondary-500 hover:bg-secondary-600 text-light" onClick={() => validate(item.id)}>Valider</button>
                                      <button className="px-5 py-3 rounded-lg bg-red-500 hover:bg-red-600 text-light" onClick={() => deny(item.id)}>Refuser</button>
                                  </td>
                              </tr>
                          ))}
                          </tbody>
